    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        class Connection extends AsyncTask<String, String, String>{
            ...
            protected String doInBackground(String... strings) {
                ...
                String host = "http://192.168.0.13/hazard/api.php";
                try{
                ...
                try {
                    ...
                    if (success == 1){
                        ...
                        for (int i=0; i < hazard.length(); i++){
                            ...
                            String hlocation = haz.getString("hz_location");
                            ...
                            String date = haz.getString("hz_date");
                            String line = "----- "+ desc+ " -----\n"+
                                            "Location: "+hlocation + "\nState: " + state + "\n"+
                                            "Reported By: "+ repname+ "\n"+
                                            "Date: "+ date+ "\n"+
                        ...
                        Toast.makeText(getApplicationContext(), "There is no new hazard", Toast.LENGTH_SHORT).show();
                    }
